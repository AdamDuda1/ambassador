...
export const HCB_BASE_URL = "https://hcb.hackclub.com";
export const HCB_OAUTH_CREDENTIALS_ROW_ID = "primary";
export const HCB_AMBASSADOR_ORGANIZATION_ID = "org_zAu3ZZ";
export const HCB_OAUTH_STATE_COOKIE_NAME = "ambassador_hcb_oauth_state";
